# Generated by Django 5.0.8 on 2024-09-20 07:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='menu',
            name='page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='website.page', verbose_name='Target Page'),
        ),
        migrations.AddField(
            model_name='website',
            name='menu',
            field=models.ForeignKey(blank=True, help_text='Parent item as the main menu of the website.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='website.menu', verbose_name='Main Menu'),
        ),
        migrations.AddConstraint(
            model_name='widget',
